...
function Pomodoro() {
  ...
  function increaseBreakDuration(){
    ...
    return setBreakDuration(current => current+1)
  }
  ...
  return (
    <div className="pomodoro">
      <div className="row">
      <div className="col">
        <FocusDuration focusDuration={focusDuration} setFocusDuration={setFocusDuration} session={session}/>
        </div>
        <div className="col">
      ...
      <Session session={session} focusDuration={focusDuration} breakDuration={breakDuration} pausing={isTimerRunning}/>
